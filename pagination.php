<?php
    ...
    $pagination = getPagination($movies["currPage"], $movies["maxPage"]);
?>
<!-- Если кол-во фильмов более 8, то показать код хтмл внутри условия if -->
<?php if ($movies["length"] > 8){ ?>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item <?php echo $pagination["prevPageArrow"]["class"]; ?>">
                <a  class="page-link"
                    href="<?php echo $pagination["prevPageArrow"]["link"]; ?>"
                    aria-label="Previous">
            ...
            <li class="page-item <?php echo $pagination["firstPage"]["class"]; ?>">
                <a  class="page-link"
                    href="<?php echo $pagination["firstPage"]["link"]; ?>">
            ...
            <li class="page-item <?php echo $pagination["lastPage"]["class"]; ?>">
                <a  class="page-link"
                    href="<?php echo $pagination["lastPage"]["link"]; ?>">
            ...
            <li class="page-item <?php echo $pagination["nextPageArrow"]["class"]; ?>">
                <a  class="page-link"
                    href="<?php echo $pagination["nextPageArrow"]["link"]; ?>"
                    aria-label="Next">
